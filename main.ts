  //Task # 1
   //Install [Node.js](https://nodejs.org/en/), [Typescript](https://ww.typescriptlang.org/download) and [VS Code](https://code.visualstudio.com/) on your computer.
